...
### 1.2 2. 核心金融原语 (Core Financial Primitives)
- [ ] 实现 `Decimal` 定点数高精度计算类 <!-- id: 3 -->
- [ ] 实现 `Currency` 货币值对象 <!-- id: 4 -->
- [ ] 实现 `Money` 资金值对象 <!-- id: 5 -->
- [ ] 实现 `ExchangeRate` 汇率值对象 <!-- id: 6 -->

### 1.3 3. 领域模型与服务 (Domain Models & Services)
...
### 1.4 4. 仓储与持久化 (Repository & Persistence)
...
### 1.5 5. 应用层用例 (Application Use Cases)
...
### 1.6 6. 表现层与 API (Presentation & APIs)
...
### 1.7 7. 基础设施与测试 (Infrastructure & Testing)
