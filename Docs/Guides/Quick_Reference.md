...
- P1-S11 Outbox、Scheduler、OpenExchangeRates Provider、认证数据清理与后台 production 装配
- Windows GCC 16 / PostgreSQL OFF：292 unit/use-case + 17 In-Memory integration + 28 framework-neutral API + 4 static gates，341/341 通过
- S10 外部基础预检：真实依赖 Debug/Release 321/321、PostgreSQL 16.14 V1-V5、双角色启动和核心 API smoke 通过

### 待办

- P1-S12: Phase 1 全量回归、文档定稿与分支交付
- 另一台机器执行 V1-V6、Linux、Docker、PostgreSQL fixture、真实 OpenExchangeRates、Outbox/Scheduler runtime、Debug/Release 和最终发布门禁
