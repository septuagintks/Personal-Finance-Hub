...
- Windows GCC 16 / PostgreSQL OFF：272 unit/use-case + 16 In-Memory integration + 29 framework-neutral API + 4 static gates，321/321 通过
...
- 另一台机器执行 V4/V5、Linux、Docker、PostgreSQL 16+、Debug/Release、真实 Drogon/API 和持久化运行时阻断门禁
