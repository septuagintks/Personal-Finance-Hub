...
#### 1. 安全性与身份认证细节 (Security & Authentication) ✅ 已完成

已在以下文档中明确规约：

- [02_Database_Design.md § 3.1](02_Database_Design.md) - 密码存储规范（Argon2id / bcrypt）
- [08_REST_API_Design.md § 6](08_REST_API_Design.md) - JWT + Refresh Token 完整机制
...
#### 5. 数据库版本演进与迁移机制 (Database Schema Migration) ✅ 已完成

已在 [02_Database_Design.md § 23](02_Database_Design.md) 中明确规约：
...
#### 2. 余额缓存的并发安全与自愈 (Concurrency & Locks on Balance Cache) ✅ 已完成

已在 [02_Database_Design.md § 9.1-9.2](02_Database_Design.md) 和 [05_Repository_and_Persistence_Design.md § 4.1](05_Repository_and_Persistence_Design.md) 中明确规约：
