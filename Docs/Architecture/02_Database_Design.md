...
V1-V9 的迁移、角色授权和重复执行由部署门禁验证；真实 PostgreSQL 结果以当前 Phase 2 交付摘要为准。操作流程见 [Database Migration Guide](../Guides/Database_Migration_Guide.md)。
