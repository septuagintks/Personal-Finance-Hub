...
V1-V6 已在 PostgreSQL 16.14 + Flyway 10.22.0 完成空库 migrate、info、validate、第二次 no-op，以及 V1-V5 legacy Outbox 升级验证。操作流程见 [Database Migration Guide](../Guides/Database_Migration_Guide.md)。
